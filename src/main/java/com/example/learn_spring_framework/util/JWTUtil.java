 ...
 * 
 * take every complex handles relate on Token into 1 class
 */
@Component 
public class JWTUtil {
	@Value("${jwt.secret}") //inject the value in application.properties
	...
	public String generateToken(String userName) {
		return Jwts.builder()
				.setSubject(userName) //set the author of token is userName
